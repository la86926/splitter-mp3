...
# Protege únicamente las liberaciones antiguas del marco y de las asas que aún
# estén presentes. La sustitución es literal y no toca ningún otro JavaScript.
text = text.replace(
...
index = re.sub(r'20260731-native\d+', '20260731-native18', index)
